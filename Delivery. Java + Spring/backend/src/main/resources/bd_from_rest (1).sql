...
--
-- Хост: 127.0.0.1
-- Время создания: Май 10 2023 г., 09:03
...
INSERT INTO `users` (`id`, `password`, `address`, `email`, `name`, `phone`, `bonus_money`, `login`) VALUES
(1, 'first_password', 'first_address', 'first_email', 'first_name', '0', 0, 'first_login');
...
--
ALTER TABLE `dishes`
  ADD CONSTRAINT `FK5ilbmc5t2uosucfj5vhqgrlib` FOREIGN KEY (`id`) REFERENCES `categories` (`id`),
